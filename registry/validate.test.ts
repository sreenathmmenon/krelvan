...
const BUILTINS = new Set(["think", "llm_route", "compose", "recall", "remember", "identify", "web_search", "http_get", "http_post", "notify_webhook", "text_transform", "email_send", "telegram_send", "slack_send", "rag.ingest", "rag.search", "wiki.ingest", "wiki.query", "delegate"]);
