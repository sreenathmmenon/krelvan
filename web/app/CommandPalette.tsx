...
const COMMANDS: Command[] = [
  ...
  // Navigate
  { id: "go-dashboard", label: "Dashboard", hint: "Page", group: "Go to", keywords: "home workspace agents", run: r => r.push("/dashboard") },
  { id: "go-runs", label: "Runs", hint: "Page", group: "Go to", keywords: "history audit trail records", run: r => r.push("/runs") },
  { id: "go-capabilities", label: "Capabilities", hint: "Page", group: "Go to", keywords: "tools marketplace discover install", run: r => r.push("/capabilities") },
