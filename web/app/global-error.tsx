      ...
      <body style={{ margin: 0, fontFamily: "system-ui, -apple-system, sans-serif", background: "#F8F7F4", color: "#11201F" }}>
        <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", textAlign: "center", padding: 24 }}>
          <div style={{ maxWidth: 440 }}>
            <div style={{ fontFamily: "monospace", fontWeight: 700, fontSize: 18, color: "#0E7C75", letterSpacing: "-0.02em", marginBottom: 12 }}>Krelvan</div>
            ...
            <button onClick={() => reset()} style={{ background: "#0E7C75", color: "#fff", border: "none", borderRadius: 8, padding: "10px 18px", fontSize: 15, cursor: "pointer" }}>
              Reload
            </button>
          </div>
        </div>
